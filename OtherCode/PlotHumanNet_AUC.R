...
s_REGm <- read.delim("OtherNetworks/Diff_str/3--HumanNet_re/m/Re_Sum_C.txt")
s_REGml <- read.delim("OtherNetworks/Diff_str/3--HumanNet_re/ml/Re_Sum_C.txt")
s_REGmlw <- read.delim("OtherNetworks/Diff_str/3--HumanNet_re/mlw/Re_Sum_C.txt")
s_REGmlwp <- read.delim("OtherNetworks/Diff_str/3--HumanNet_re/mlwp/Re_Sum_C.txt")
s_REGmlwpFC <- read.delim("OtherNetworks/Diff_str/3--HumanNet_re/mlwpFC/Re_Sum_C.txt")
...
#DEGm
NormalDPRim<-read.delim("OtherNetworks/Diff_str/3--HumanNet_re/m/NormalDPR.txt") 
dataD_im<-read.delim("OtherNetworks/Diff_str/3--HumanNet_re/m/dataD.txt")
...
#DEGml
NormalDPRil<-read.delim("OtherNetworks/Diff_str/3--HumanNet_re/ml/NormalDPR.txt") 
dataD_il<-read.delim("OtherNetworks/Diff_str/3--HumanNet_re/ml/dataD.txt")
...
#DEGmlw
NormalDPRimlw<-read.delim("OtherNetworks/Diff_str/3--HumanNet_re/mlw/NormalDPR.txt") 
dataD_imlw<-read.delim("OtherNetworks/Diff_str/3--HumanNet_re/mlw/dataD.txt")
...
#DEGmlwp
NormalDPRimlwp<-read.delim("OtherNetworks/Diff_str/3--HumanNet_re/mlwp/NormalDPR.txt") 
dataD_imlwp<-read.delim("OtherNetworks/Diff_str/3--HumanNet_re/mlwp/dataD.txt")
...
#DEGmlwp
NormalDPRimlwpFC<-read.delim("OtherNetworks/Diff_str/3--HumanNet_re/mlwpFC/NormalDPR.txt") 
dataD_imlwpFC<-read.delim("OtherNetworks/Diff_str/3--HumanNet_re/mlwpFC/dataD.txt")
...
HNa1 <- ggplot(data=ggtest,aes(x=x1,y=y1,group = type))+geom_line(aes(x=x1,y=y1,color = type),size = 1,linetype = 1)+labs(y="Sensitivity",x="1-Specificity",
...
HNa1<-ggplot(data=ggtest,aes(x=x1,y=y1,group = type))+geom_line(aes(x=x1,y=y1,color = type),size = 1,linetype = 1)+labs(y="Sensitivity",x="1-Specificity",
                                                                                                                        title="HumanNet" ,family = "Times", color="black")+
  theme_bw()+
